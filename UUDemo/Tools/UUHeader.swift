...
/* 状态栏高度 */
let kNavigationHeightAndStatusBarHeight = kNavigationHeight + kStatuBarHeight
/* iOS系统版本 */
let kiOSVersion = UIDevice.current.systemVersion



//let radomColor = UIColor(r: CGFloat(arc4random_uniform(255)), g: CGFloat(arc4random_uniform(255)), b: CGFloat(arc4random_uniform(255)))
